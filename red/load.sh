...
redisgraph-bulk-loader \
    ...
    --relations-with-type IS_LOCATED_IN "${IMPORT_DATA_DIR_PROJECTED_FK}/Comment_isLocatedIn_Place.csv" \
    ...
    --relations-with-type IS_LOCATED_IN "${IMPORT_DATA_DIR_PROJECTED_FK}/Post_isLocatedIn_Place.csv" \
