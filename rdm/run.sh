...
export QUERY=5; ${RAPIDMATCH_ISOMORPHIC_DIR}/build/matching/RapidMatch.out  ${RAPIDMATCH_PARAMS} -d ${DATA_GRAPH} -q rdm/query_graphs/q${QUERY}.graph | python3 rdm/process.py
