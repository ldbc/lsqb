...
if len(sys.argv) < 2:
    ...
    print("where sf is the scale factor and system/variant are optional (default: system='Materialize', variant='')")
    exit(1)
else:
    sf = sys.argv[1]
...
con = psycopg2.connect(host="localhost", user="materialize", password="", port=6875)
